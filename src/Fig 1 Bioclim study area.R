...
read.csv("data/Bioclim_study_area.csv", sep= ";") %>%
  ...
  theme (plot.title = element_text (size = 23), #hjust = 0.5,
         ...
         legend.position = "none") -> fig2b_1;fig2b_1
...
read.csv("data/Bioclim_study_area.csv", sep= ";") %>%
  ...
  theme (plot.title = element_text (size = 23), #hjust = 0.5,
         ...
         axis.title.x = element_blank(), 
         axis.text.x= element_text (size = 14, color = "black"),
         legend.position = "none")-> fig2b_2;fig2b_2
...
read.csv("data/weekly_picos_graph.csv", sep = ";") %>%
  ...
  geom_hline(yintercept=0, linetype ="dashed", size =1, colour = "red") -> fig2c; fig2c
...
ggplot(temp, aes ()) +
  ...
  geom_hline(yintercept=0, linetype ="dashed", size =1, colour = "red") -> fig2d; fig2d